 ...
 * Do not edit the class manually.
 */
class FileSvcUploadsResponse {
    static getAttributeTypeMap() {
        return FileSvcUploadsResponse.attributeTypeMap;
    }
}
FileSvcUploadsResponse.discriminator = undefined;
FileSvcUploadsResponse.attributeTypeMap = [
    {
        "name": "uploads",
        "baseName": "uploads",
...
class FileSvcApi {
     ...
     */
    listUploads(uploadFileRequest_1) {
        return __awaiter(this, arguments, void 0, function* (uploadFileRequest, options = { headers: {} }) {
