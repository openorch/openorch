 ...
 * Do not edit the class manually.
 */
class FileSvcDownloadDetails {
    static getAttributeTypeMap() {
        return FileSvcDownloadDetails.attributeTypeMap;
    }
}
FileSvcDownloadDetails.discriminator = undefined;
FileSvcDownloadDetails.attributeTypeMap = [
    {
        "name": "cancelled",
        "baseName": "cancelled",
        "type": "boolean"
