 ...
 * Do not edit the class manually.
 */
class OpenapiChatSvcMessage {
    static getAttributeTypeMap() {
        return OpenapiChatSvcMessage.attributeTypeMap;
    }
}
OpenapiChatSvcMessage.discriminator = undefined;
OpenapiChatSvcMessage.attributeTypeMap = [
    {
        "name": "createdAt",
        "baseName": "createdAt",
        "type": "string"
 ...
 * Do not edit the class manually.
 */
var OpenapiPromptSvcPromptType;
(function (OpenapiPromptSvcPromptType) {
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeImageTextToText"] = 'Image-Text-to-Text'] = "PromptTypeImageTextToText";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeVisualQuestionAnswering"] = 'Visual Question Answering'] = "PromptTypeVisualQuestionAnswering";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeDocumentQuestionAnswering"] = 'Document Question Answering'] = "PromptTypeDocumentQuestionAnswering";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextToImage"] = 'Text-to-Image'] = "PromptTypeTextToImage";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeImageToImage"] = 'Image-to-Image'] = "PromptTypeImageToImage";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeImageToVideo"] = 'Image-to-Video'] = "PromptTypeImageToVideo";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeUnconditionalImageGeneration"] = 'Unconditional Image Generation'] = "PromptTypeUnconditionalImageGeneration";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextToVideo"] = 'Text-to-Video'] = "PromptTypeTextToVideo";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeZeroShotImageClassification"] = 'Zero-Shot Image Classification'] = "PromptTypeZeroShotImageClassification";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeZeroShotObjectDetection"] = 'Zero-Shot Object Detection'] = "PromptTypeZeroShotObjectDetection";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextTo3D"] = 'Text-to-3D'] = "PromptTypeTextTo3D";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeImageTo3D"] = 'Image-to-3D'] = "PromptTypeImageTo3D";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeImageFeatureExtraction"] = 'Image Feature Extraction'] = "PromptTypeImageFeatureExtraction";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeKeypointDetection"] = 'Keypoint Detection'] = "PromptTypeKeypointDetection";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextToText"] = 'Text-to-Text'] = "PromptTypeTextToText";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeQuestionAnswering"] = 'Question Answering'] = "PromptTypeQuestionAnswering";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTranslation"] = 'Translation'] = "PromptTypeTranslation";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeSummarization"] = 'Summarization'] = "PromptTypeSummarization";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextGeneration"] = 'Text Generation'] = "PromptTypeTextGeneration";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeFillMask"] = 'Fill-Mask'] = "PromptTypeFillMask";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextToSpeech"] = 'Text-to-Speech'] = "PromptTypeTextToSpeech";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeTextToAudio"] = 'Text-to-Audio'] = "PromptTypeTextToAudio";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeAutomaticSpeechRecognition"] = 'Automatic Speech Recognition'] = "PromptTypeAutomaticSpeechRecognition";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeAudioToAudio"] = 'Audio-to-Audio'] = "PromptTypeAudioToAudio";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeAudioClassification"] = 'Audio Classification'] = "PromptTypeAudioClassification";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeReinforcementLearning"] = 'Reinforcement Learning'] = "PromptTypeReinforcementLearning";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeRobotics"] = 'Robotics'] = "PromptTypeRobotics";
    OpenapiPromptSvcPromptType[OpenapiPromptSvcPromptType["PromptTypeGraphMachineLearning"] = 'Graph Machine Learning'] = "PromptTypeGraphMachineLearning";
