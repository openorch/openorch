...
export class UserSvcApi {
     ...
     * @param body Change Password Request
     */
    public async changePasswordAdmin (body: UserSvcChangePasswordAdminRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
