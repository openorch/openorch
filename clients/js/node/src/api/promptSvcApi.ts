...
export class PromptSvcApi {
     ...
     */
    public async addPrompt (body: PromptSvcAddPromptRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PromptSvcAddPromptResponse;  }> {
