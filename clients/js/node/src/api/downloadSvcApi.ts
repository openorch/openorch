...
export class DownloadSvcApi {
     ...
     */
    public async download (body: DownloadSvcDownloadRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: any; };  }> {
