...
import type {
  ...
  ContainerSvcGetDockerHostResponse,
...
import {
    ...
    ContainerSvcGetDockerHostResponseFromJSON,
    ContainerSvcGetDockerHostResponseToJSON,
...
export class ContainerSvcApi extends runtime.BaseAPI {
     ...
     */
    async imageExistsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContainerSvcGetDockerHostResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ContainerSvcGetDockerHostResponseFromJSON(jsonValue));
    }
     ...
     * Container Image Exists
     */
    async imageExists(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ContainerSvcGetDockerHostResponse> {
        const response = await this.imageExistsRaw(initOverrides);
        return await response.value();
    }
