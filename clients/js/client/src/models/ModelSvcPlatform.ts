...
import type { OpenapiPromptSvcPromptType } from './OpenapiPromptSvcPromptType';
import {
    OpenapiPromptSvcPromptTypeFromJSON,
    OpenapiPromptSvcPromptTypeFromJSONTyped,
    OpenapiPromptSvcPromptTypeToJSON,
    OpenapiPromptSvcPromptTypeToJSONTyped,
} from './OpenapiPromptSvcPromptType';
...
export function ModelSvcPlatformFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelSvcPlatform {
    ...
    return {
        ...
        'types': json['types'] == null ? undefined : ((json['types'] as Array<any>).map(OpenapiPromptSvcPromptTypeFromJSON)),
...
export function ModelSvcPlatformToJSONTyped(value?: ModelSvcPlatform | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'id': value['id'],
        'name': value['name'],
        'types': value['types'] == null ? undefined : ((value['types'] as Array<any>).map(OpenapiPromptSvcPromptTypeToJSON)),
