    ...
    downloadRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new runtime.RequiredError('body', 'Required parameter "body" was null or undefined when calling download().');
            }
            ...
            const response = yield this.request({
                ...
                body: DownloadSvcDownloadRequest.DownloadSvcDownloadRequestToJSON(requestParameters['body']),
            }, initOverrides);
