...
class UserSvcApi extends runtime.BaseAPI {
    ...
    addUserToOrganizationRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcAddUserToOrganizationRequest.UserSvcAddUserToOrganizationRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    changePasswordRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcChangePasswordRequest.UserSvcChangePasswordRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    changePasswordAdminRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new runtime.RequiredError('body', 'Required parameter "body" was null or undefined when calling changePasswordAdmin().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcChangePasswordAdminRequest.UserSvcChangePasswordAdminRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    createOrganizationRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcCreateOrganizationRequest.UserSvcCreateOrganizationRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    createRoleRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcCreateRoleRequest.UserSvcCreateRoleRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    createUserRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcCreateUserRequest.UserSvcCreateUserRequestToJSON(requestParameters['body']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response);
        });
    }
    ...
    getUsersRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcGetUsersRequest.UserSvcGetUsersRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    loginRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: UserSvcLoginRequest.UserSvcLoginRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    registerRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => UserSvcRegisterResponse.UserSvcRegisterResponseFromJSON(jsonValue));
        });
    }
    /**
     * Register a new user with a name, email, and password.
