...
function ModelSvcGetModelResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        '_exists': json['exists'],
        'model': ModelSvcModel.ModelSvcModelFromJSON(json['model']),
        'platform': ModelSvcPlatform.ModelSvcPlatformFromJSON(json['platform']),
    };
}
...
exports.ModelSvcGetModelResponseToJSONTyped = ModelSvcGetModelResponseToJSONTyped;
