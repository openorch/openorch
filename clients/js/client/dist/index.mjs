 ...
 */
function instanceOfFileSvcDownloadRequest(value) {
    return true;
}
function FileSvcDownloadRequestFromJSON(json) {
    return FileSvcDownloadRequestFromJSONTyped(json);
}
function FileSvcDownloadRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FileSvcDownloadRequestToJSON(json) {
    return FileSvcDownloadRequestToJSONTyped(json, false);
}
function FileSvcDownloadRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfFileSvcUploadsResponse(value) {
    return true;
}
function FileSvcUploadsResponseFromJSON(json) {
    return FileSvcUploadsResponseFromJSONTyped(json);
}
function FileSvcUploadsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FileSvcUploadsResponseToJSON(json) {
    return FileSvcUploadsResponseToJSONTyped(json, false);
}
function FileSvcUploadsResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
 ...
 */
function instanceOfUploadFileRequest(value) {
    if (!('file' in value) || value['file'] === undefined)
        return false;
    return true;
}
function UploadFileRequestFromJSON(json) {
    return UploadFileRequestFromJSONTyped(json);
}
function UploadFileRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UploadFileRequestToJSON(json) {
    return UploadFileRequestToJSONTyped(json, false);
}
function UploadFileRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
class FileSvcApi extends BaseAPI {
    ...
    listUploadsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['uploadFileRequest'] == null) {
                throw new RequiredError('uploadFileRequest', 'Required parameter "uploadFileRequest" was null or undefined when calling listUploads().');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            ...
            return new JSONApiResponse(response, (jsonValue) => FileSvcUploadsResponseFromJSON(jsonValue));
        });
    }
    /**
     * List the uploaded files.  Requires the `file-svc:upload:view` permission.
    ...
    pauseDownloadRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['downloadId'] == null) {
                throw new RequiredError('downloadId', 'Required parameter "downloadId" was null or undefined when calling pauseDownload().');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (this.configuration && this.configuration.apiKey) {
