 ...
 */
function instanceOfDataSvcUpdateObjectRequest(value) {
    return true;
}
function DataSvcUpdateObjectRequestFromJSON(json) {
    return DataSvcUpdateObjectRequestFromJSONTyped(json);
}
function DataSvcUpdateObjectRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function DataSvcUpdateObjectRequestToJSON(json) {
    return DataSvcUpdateObjectRequestToJSONTyped(json, false);
}
function DataSvcUpdateObjectRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
