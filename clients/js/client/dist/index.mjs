 ...
 */
function instanceOfFileSvcDownloadDetails(value) {
    return true;
}
function FileSvcDownloadDetailsFromJSON(json) {
    return FileSvcDownloadDetailsFromJSONTyped(json);
}
function FileSvcDownloadDetailsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function FileSvcDownloadDetailsToJSON(json) {
    return FileSvcDownloadDetailsToJSONTyped(json, false);
}
function FileSvcDownloadDetailsToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
function FileSvcDownloadsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'downloads': json['downloads'] == null ? undefined : (json['downloads'].map(FileSvcDownloadDetailsFromJSON)),
    };
}
...
function FileSvcDownloadsResponseToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        'downloads': value['downloads'] == null ? undefined : (value['downloads'].map(FileSvcDownloadDetailsToJSON)),
    };
}
