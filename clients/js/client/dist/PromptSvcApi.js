    ...
    addPromptRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            if (requestParameters['body'] == null) {
                throw new runtime.RequiredError('body', 'Required parameter "body" was null or undefined when calling addPrompt().');
            }
            ...
            const response = yield this.request({
                ...
                body: PromptSvcAddPromptRequest.PromptSvcAddPromptRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    listPromptsRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: PromptSvcListPromptsRequest.PromptSvcListPromptsRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    removePromptRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: PromptSvcRemovePromptRequest.PromptSvcRemovePromptRequestToJSON(requestParameters['body']),
            }, initOverrides);
