    ...
    checkRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: PolicySvcCheckRequest.PolicySvcCheckRequestToJSON(requestParameters['body']),
            }, initOverrides);
    ...
    upsertInstanceRaw(requestParameters, initOverrides) {
        return runtime.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: PolicySvcUpsertInstanceRequest.PolicySvcUpsertInstanceRequestToJSON(requestParameters['body']),
            }, initOverrides);
