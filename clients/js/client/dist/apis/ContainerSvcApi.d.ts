...
import type { ContainerSvcBuildImageRequest, ContainerSvcContainerIsRunningResponse, ContainerSvcGetContainerSummaryResponse, ContainerSvcGetDockerHostResponse, ContainerSvcGetInfoResponse, ContainerSvcRunContainerRequest, ContainerSvcRunContainerResponse, ContainerSvcStopContainerRequest } from '../models/index';
...
export declare class ContainerSvcApi extends runtime.BaseAPI {
     ...
     */
    imageExistsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContainerSvcGetDockerHostResponse>>;
    /**
     * Check if an image exists on in the container registry and is pullable.
     * Container Image Exists
     */
    imageExists(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ContainerSvcGetDockerHostResponse>;
    /**
