...
export function instanceOfOpenapiPromptSvcPromptType(value) {
...
export function OpenapiPromptSvcPromptTypeFromJSON(json) {
    return OpenapiPromptSvcPromptTypeFromJSONTyped(json, false);
}
export function OpenapiPromptSvcPromptTypeFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function OpenapiPromptSvcPromptTypeToJSON(value) {
    return value;
}
export function OpenapiPromptSvcPromptTypeToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
