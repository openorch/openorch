...
Requires the `container-svc:image:build` permission.
	...
	*/
	...
	//  @return ContainerSvcGetInfoResponse
	GetInfoExecute(r ApiGetInfoRequest) (*ContainerSvcGetInfoResponse, *http.Response, error)

	/*
	ImageExists Container Image Exists

	Check if an image exists on in the container registry and is pullable.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiImageExistsRequest
	*/
	ImageExists(ctx context.Context) ApiImageExistsRequest

	// ImageExistsExecute executes the request
	//  @return ContainerSvcGetDockerHostResponse
	ImageExistsExecute(r ApiImageExistsRequest) (*ContainerSvcGetDockerHostResponse, *http.Response, error)
...
func (r ApiGetInfoRequest) Execute() (*ContainerSvcGetInfoResponse, *http.Response, error) {
...
Retrieve detailed information about the Container service
 ...
 @return ApiGetInfoRequest
*/
func (a *ContainerSvcAPIService) GetInfo(ctx context.Context) ApiGetInfoRequest {
	return ApiGetInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ContainerSvcGetInfoResponse
func (a *ContainerSvcAPIService) GetInfoExecute(r ApiGetInfoRequest) (*ContainerSvcGetInfoResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ContainerSvcGetInfoResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerSvcAPIService.GetInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/container-svc/info"
...
type ApiImageExistsRequest struct {
	ctx context.Context
	ApiService ContainerSvcAPI
}

func (r ApiImageExistsRequest) Execute() (*ContainerSvcGetDockerHostResponse, *http.Response, error) {
	return r.ApiService.ImageExistsExecute(r)
}
...
Check if an image exists on in the container registry and is pullable.
 ...
 @return ApiImageExistsRequest
*/
func (a *ContainerSvcAPIService) ImageExists(ctx context.Context) ApiImageExistsRequest {
	return ApiImageExistsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ContainerSvcGetDockerHostResponse
func (a *ContainerSvcAPIService) ImageExistsExecute(r ApiImageExistsRequest) (*ContainerSvcGetDockerHostResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ContainerSvcGetDockerHostResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContainerSvcAPIService.ImageExists")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
