...
// @Accept json
// @Produce json
// @Param body body secret.WriteSecretsRequest true "Write Secret Request"
// @Success 200 {object} secret.WriteSecretsResponse "Write Secret Response"
...
func (cs *SecretService) Write(
	...
	req := &secret.WriteSecretsRequest{}
	...
	jsonData, _ := json.Marshal(secret.WriteSecretsResponse{})
	w.Write(jsonData)
}
