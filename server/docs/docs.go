    ...
    "definitions": {
        ...
        "container_svc.Container": {
            ...
            "properties": {
                ...
                "hostPort": {
                    "description": "HostPort is the port on the host machine mapped to the container’s internal port.",
                    "type": "integer"
                },
                "id": {
                ...
                "name": {
                    "description": "Name is the human-readable name assigned to the container.",
                    "type": "string"
                },
                "nodeId": {
                ...
                "port": {
                    "description": "Port is the internal port exposed by the container.",
                    "type": "integer"
                },
                "status": {
